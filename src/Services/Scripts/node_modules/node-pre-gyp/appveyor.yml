...
install:
  ...
  - IF /I "%PLATFORM%" == "x64" CALL "C:\Program Test.TestFiles (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" amd64
  - IF /I "%PLATFORM%" == "x86" CALL "C:\Program Test.TestFiles (x86)\Microsoft Visual Studio 14.0\VC\vcvarsall.bat" x86
  - npm install
  - npm test
